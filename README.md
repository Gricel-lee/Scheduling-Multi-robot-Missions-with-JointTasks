...
## Tool description
The approach taken for the scheduling of tasks consists in three stages. Stage one is the inputs as in ![my directory](./Hospital-Example/2 Input specifications)
