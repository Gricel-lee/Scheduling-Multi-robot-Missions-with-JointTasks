...
module R1_0
   ...
   [r1_0_0_to_4] r1_0=0 & r1_0_at2_2=false -> (r1_0' = 4) & (r1_0_at2_2'=true);
   [r1_0_0_to_5] r1_0=0 & r1_0_at1_0=false -> (r1_0' = 5) & (r1_0_at1_0'=true);
   [r1_0_0_to_6] r1_0=0 & r1_0_at1_1=false -> (r1_0' = 6) & (r1_0_at1_1'=true);
   [r1_0_0_to_7] r1_0=0 & r1_0_at1_2=false -> (r1_0' = 7) & (r1_0_at1_2'=true);
   // travel from state 1
   ...
   [r1_0_2_to_4] r1_0=2 & r1_0_at2_2=false & r1_0_at1_0=true -> (r1_0' = 4) & (r1_0_at2_2'=true);
   ...
   [r1_0_2_to_7] r1_0=2 & r1_0_at1_2=false & r1_0_at1_0=true -> (r1_0' = 7) & (r1_0_at1_2'=true);
   ...
   [r1_0_3_to_4] r1_0=3 & r1_0_at2_2=false & r1_0_at1_1=true -> (r1_0' = 4) & (r1_0_at2_2'=true);
   ...
   [r1_0_3_to_7] r1_0=3 & r1_0_at1_2=false & r1_0_at1_1=true -> (r1_0' = 7) & (r1_0_at1_2'=true);
   ...
   [r1_0_4_to_7] r1_0=4 & r1_0_at1_2=false & r1_0_at1_2=false -> (r1_0' = 7) & (r1_0_at1_2'=true);
   ...
   [r1_0_5_to_4] r1_0=5 & r1_0_at2_2=false & r1_0_at2_0=true -> (r1_0' = 4) & (r1_0_at2_2'=true);
   [r1_0_5_to_6] r1_0=5 & r1_0_at1_1=false & r1_0_at2_0=true -> (r1_0' = 6) & (r1_0_at1_1'=true);
   [r1_0_5_to_7] r1_0=5 & r1_0_at1_2=false & r1_0_at2_0=true -> (r1_0' = 7) & (r1_0_at1_2'=true);
   ...
   [r1_0_6_to_4] r1_0=6 & r1_0_at2_2=false & r1_0_at2_1=true -> (r1_0' = 4) & (r1_0_at2_2'=true);
   [r1_0_6_to_5] r1_0=6 & r1_0_at1_0=false & r1_0_at2_1=true -> (r1_0' = 5) & (r1_0_at1_0'=true);
   [r1_0_6_to_7] r1_0=6 & r1_0_at1_2=false & r1_0_at2_1=true -> (r1_0' = 7) & (r1_0_at1_2'=true);
   ...
   [r1_0_7_to_4] r1_0=7 & r1_0_at2_2=false & r1_0_at2_2=false -> (r1_0' = 4) & (r1_0_at2_2'=true);
...
rewards
   ...
   [r1_0_5_to_4] true: 400;
   [r1_0_5_to_6] true: 100;
   [r1_0_5_to_7] true: 400;
   [r1_0_6_to_1] true: 412;
   [r1_0_6_to_2] true: 100;
   [r1_0_6_to_3] true: 0;
   [r1_0_6_to_4] true: 412;
   [r1_0_6_to_5] true: 100;
   [r1_0_6_to_7] true: 412;
   [r1_0_7_to_1] true: 0;
